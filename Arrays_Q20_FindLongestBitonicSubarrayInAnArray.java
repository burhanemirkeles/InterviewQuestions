public class Arrays_Q20_FindLongestBitonicSubarrayInAnArray {
    /*
    The Longest Bitonic Subarray (LBS) problem is to find a subarray of a given sequence in which the subarray's element
    are first sorted in increasing order, then in decreasing order, and the subarray is as long as possible. Strictly
    ascending or descending subarrays are also accepted.
    ...
    public static void findBitonicSubarray(int[] A)
    {
        ...
        System.out.printf("The longest bitonic subarray is [%d, %d]", beg, end);
    }
