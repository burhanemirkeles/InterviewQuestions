public class Array_Q16_FindTheLargestSubarrayFormedByConsecutiveIntegers {
    /*
    Given an integer array, find the largest subarray formed by consecutive integers.The subarray should contain all
    distinct values.
